...
int main(int argc, char *argv[])
{
	...
	PCRE2_SPTR pattern = (PCRE2_SPTR)"(\\G[0][2][-]\\d{3,4}[-]\\d{4})\\Z|(\\G[0][3][1][-]\\d{3,4}[-]\\d{4}\\Z)|(\\G[0][1][0][-]\\d{3,4}[-]\\d{4}\\Z)|(\\G[0][1][6][-]\\d{3,4}[-]\\d{4}\\Z)|(\\G[0][1][9][-]\\d{3,4}[-]\\d{4}\\Z)"; // write regular expression here
	while (num--)
	{
	...
	PCRE2_SPTR pattern2 = (PCRE2_SPTR)"\\G(\\d{1,2}|[1]\\d{2}|[2][0]\\d|[2][1]\\d|[2][2]\\d|[2][3]\\d|[2][4]\\d|[2][5][0]|[2][5][1]|[2][5][2]|[2][5][3]|[2][5][4]|[2][5][5])([.](\\d{1,2}|[1]\\d{2}|[2][0]\\d|[2][1]\\d|[2][2]\\d|[2][3]\\d|[2][4]\\d|[2][5][0]|[2][5][1]|[2][5][2]|[2][5][3]|[2][5][4]|[2][5][5])){3}\\s-\\s-\\s\\[(\\d{1}|[1]\\d{1}|[2]\\d{1}|30)\\/Apr\\/2018\\]\\s(\")GET\\s\\/admin\\sHTTP\\/1.1(\")\\s304\\s0\\s(\")-(\")\\s(\")Mozilla\\/5.0(\\s+)\\(Macintosh;\\sIntel\\sMac\\sOS\\sX\\s10_13_3\\)\\sAppleWebKit\\/537.36\\s\\(KHTML.\\slike(\\s+)Gecko\\)\\sChrome\\/65.0.3325.181\\sSafari\\/537.36(\")\\s(\")-(\")\\Z"; // write regular expression here
	while (num--)
	{
		fgets(strTemp, sizeof(strTemp), fp);
		PCRE2_SPTR input = (PCRE2_SPTR)strTemp;
